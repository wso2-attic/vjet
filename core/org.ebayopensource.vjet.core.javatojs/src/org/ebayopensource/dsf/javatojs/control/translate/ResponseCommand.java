...
import java.util.concurrent.Callable;
  ...
  public abstract class ResponseCommand implements Callable
  {
      ...
      /**
       * setIsDone called by the Worker thread - in the absence of Tracker
       * would set the done flag and call on notify
       * in the presence of tracker would call setDone on tracker
       * 
       * Note that command should not call this method - it will
       * be called by the CommandRunner itself.
       */
    ...
    public Object call() throws Exception {
       ...
       * Command implementation is free to overrise this method in order
       * to perform graceful cancellation for the cases when command
       * has already started.
       */
