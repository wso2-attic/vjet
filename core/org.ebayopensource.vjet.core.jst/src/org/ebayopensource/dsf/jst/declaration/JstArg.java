...
public class JstArg extends BaseJstNode {
	...
	// Constructor
	//
	public JstArg(final IJstType type, final String name, final boolean isVarargs){
		this(new JstTypeReference(type), name, isVarargs);
	}
	public JstArg(final IJstType type, final String name, final boolean isVarargs, final boolean isOptional){
		this(new JstTypeReference(type), name, isVarargs, isOptional);
	}
	
	public JstArg(final IJstType type, final String name, final boolean isVarargs, final boolean isOptional, final boolean isFinal){
		this(new JstTypeReference(type), name, isVarargs, isOptional, isFinal);
	}
	
	public JstArg(final IJstTypeReference type, final String name, final boolean isVarargs){
		m_types.add(type);
		m_name = name;
	...
	public JstArg(final IJstTypeReference type, final String name, final boolean isVarargs, final boolean isOptional){
		m_types.add(type);
		m_name = name;
		m_isVariable = isVarargs;
	...
	public JstArg(final IJstTypeReference type, final String name, final boolean isVarargs, final boolean isOptional, final boolean isFinal){
		m_types.add(type);
		m_name = name;
		m_isVariable = isVarargs;
		m_isOptional = isOptional;
	...
	public JstArg(final List<IJstType> types, final String name, final boolean isVarargs, final boolean isOptional){
	...
	public JstArg(final List<IJstType> types, final String name, final boolean isVarargs, final boolean isOptional, final boolean isFinal){
		assert name != null : "name is null";
	...
	public JstArg(final List<? extends IJstTypeReference> types, int a,final String name, final boolean isVarargs, final boolean isOptional){
		assert name != null : "name is null";
	...
	public JstArg(final List<? extends IJstTypeReference> types, int a,final String name, final boolean isVarargs, final boolean isOptional, final boolean isFinal){
		assert name != null : "name is null";
	...
	private boolean isTypeExists(IJstType type) {
		for (int i = 0; i < m_types.size(); i++) {
			if (null != type.getName() && type.getName().equals(m_types.get(i).getReferencedType().getName())) {
				return true;
			}
		}
		return false;
