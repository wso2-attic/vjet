...
//import org.ebayopensource.dsf.jsgen.shared.ids.ConstructorProbIds;
...
//		QUALIFIER_SHOULD_BE_DEFINED.setGlobalPolicy(GLOBAL_ERROR_POLICY);
		...
		DUPLICATE_METHOD.setGlobalPolicy(GLOBAL_ERROR_POLICY);
		DUPLICATE_PROPERTY.setGlobalPolicy(GLOBAL_ERROR_POLICY);
		OVERLAP_STATIC_AND_NONE_STATIC_METHOD.setGlobalPolicy(GLOBAL_ERROR_POLICY);
		OVERLAP_STATIC_AND_NONE_STATIC_PROPERTY.setGlobalPolicy(GLOBAL_ERROR_POLICY);
...
//		HIERARCHY_AND_STRUCTURE.addRule(SUPER_CLASS_MUST_PROVIDE_CONSTRUCTOR);
		HIERARCHY_AND_STRUCTURE.addRule(SUPER_CLASS_SHOULD_NOT_BE_FINAL);
		HIERARCHY_AND_STRUCTURE.addRule(SUPER_CLASS_SHOULD_NOT_BE_THE_SAME);
		HIERARCHY_AND_STRUCTURE.addRule(CLASS_SHOULD_NOT_BE_BOTH_FINAL_AND_ABSTRACT);
		HIERARCHY_AND_STRUCTURE.addRule(INTERFACE_SHOULD_NOT_BE_FINAL);
		HIERARCHY_AND_STRUCTURE.addRule(METHOD_OR_PROPERTY_SHOULD_NOT_BE_BOTH_FINAL_AND_ABSTRACT);
		HIERARCHY_AND_STRUCTURE.addRule(METHOD_OR_PROPERTY_SHOULD_NOT_BE_BOTH_STATIC_AND_ABSTRACT);
		HIERARCHY_AND_STRUCTURE.addRule(METHOD_OR_PROPERTY_SHOULD_NOT_BE_BOTH_PRIVATE_AND_ABSTRACT);
		HIERARCHY_AND_STRUCTURE.addRule(CLASS_SHOULD_BE_ABSTRACT);
		HIERARCHY_AND_STRUCTURE.addRule(ETYPE_SHOULD_NOT_BE_ABSTRACT_OR_PRIVATE_OR_PROTECTED);
		HIERARCHY_AND_STRUCTURE.addRule(ETYPE_SHOULD_NOT_DEFINE_PUBLIC_OR_PROTECTED_CONSTRUCTOR);
		HIERARCHY_AND_STRUCTURE.addRule(ETYPE_SHOULD_NOT_DEFINE_ABSTRACT_METHOD_OR_PROPERTY);
		HIERARCHY_AND_STRUCTURE.addRule(ITYPE_OR_MTYPE_SHOULD_NOT_HAVE_CONSTRUCTOR);
		HIERARCHY_AND_STRUCTURE.addRule(ITYPE_SHOULD_NOT_DEFINE_STATIC_METHODS);
		HIERARCHY_AND_STRUCTURE.addRule(ITYPE_SHOULD_NOT_EXTEND_NONE_ITYPE_CLASS);
		HIERARCHY_AND_STRUCTURE.addRule(CTYPE_SHOULD_NOT_EXTEND_NONE_CTYPE_CLASS);
		HIERARCHY_AND_STRUCTURE.addRule(CTYPE_SHOULD_NOT_IMPLEMENT_NONE_ITYPE_INTERFACE);
		HIERARCHY_AND_STRUCTURE.addRule(OVERRIDE_METHOD_SHOULD_HAVE_COMPATIBLE_SIGNATURE);
//		HIERARCHY_AND_STRUCTURE.addRule(IMPLEMENT_METHOD_SHOULD_HAVE_COMPATIBLE_SIGNATURE);
		HIERARCHY_AND_STRUCTURE.addRule(MIXIN_EXPECTS_INSTANCE_METHOD_MUST_BE_SATISFIED);
		HIERARCHY_AND_STRUCTURE.addRule(MIXIN_EXPECTS_INSTANCE_PROP_MUST_BE_SATISFIED);
...
//		HIERARCHY_AND_STRUCTURE.addRule(MTYPE_EXPECTS_SHOULD_NOT_BE_OVERWRITTEN);
        HIERARCHY_AND_STRUCTURE.addRule(MIXINED_TYPE_MUST_NOT_BE_ITSELF);
//		HIERARCHY_AND_STRUCTURE.addRule(MTYPE_SHOULD_NOT_BE_REFERENCED_DIRECTLY);
		HIERARCHY_AND_STRUCTURE.addRule(MTYPE_SHOULD_ONLY_BE_MIXINED);
        HIERARCHY_AND_STRUCTURE.addRule(EXPECTS_MUST_BE_CTYPE_ITYPE);
		HIERARCHY_AND_STRUCTURE.addRule(INNER_TYPE_SHOULD_NOT_HAVE_NAME_SAME_AS_EMBEDDING_TYPE);
		HIERARCHY_AND_STRUCTURE.addRule(INSTANCE_INNER_TYPE_SHOULD_NOT_HAVE_STATIC_MEMBERS);
		HIERARCHY_AND_STRUCTURE.addRule(OVERRIDE_METHOD_SHOULD_NOT_REDUCE_VISIBILITY);
		HIERARCHY_AND_STRUCTURE.addRule(ABSTRACT_METHOD_MUST_BE_IMPLEMENTED);
		HIERARCHY_AND_STRUCTURE.addRule(FINAL_METHOD_SHOULD_NOT_BE_OVERRIDEN);
		HIERARCHY_AND_STRUCTURE.addRule(STATIC_METHOD_SHOULD_NOT_BE_OVERRIDEN);
		
//		MISC.addRule(QUALIFIER_SHOULD_NOT_BE_NULL);
//		MISC.addRule(QUALIFIER_SHOULD_BE_DEFINED);
		MISC.addRule(PROPERTY_SHOULD_BE_DEFINED);
		MISC.addRule(METHOD_SHOULD_BE_DEFINED);
		MISC.addRule(FUNCTION_SHOULD_BE_DEFINED);
		MISC.addRule(METHOD_WRONG_NUMBER_OF_ARGS);
		MISC.addRule(NONE_VOID_METHOD_SHOULD_HAVE_RETURN);
		MISC.addRule(VOID_METHOD_SHOULD_NOT_HAVE_RETURN);
//		MISC.addRule(ARRAY_CREATION_VAL_SHOULD_BE_DEFINED);
//		MISC.addRule(CLASS_OBJ_SHOULD_BE_DEFINED);
		MISC.addRule(FINAL_PROPERTY_SHOULD_BE_INITIALIZED);
		MISC.addRule(VARIABLE_SHOULD_BE_DEFINED);
		MISC.addRule(IMPLICIT_GLOBAL_VARIABLE_DECLARED);
		MISC.addRule(SHOULD_NOT_ASSIGN_TO_ENUM);
		MISC.addRule(SHOULD_NOT_ASSIGN_TO_FINAL);
		MISC.addRule(PRIVATE_METHOD_REFERENCED_NOWHERE);
		MISC.addRule(PRIVATE_PROPERTY_REFERENCED_NOWHERE);
		MISC.addRule(OVERLOAD_METHOD_SHOULD_NOT_OVERLAP);
//		MISC.addRule(OVERLOAD_METHOD_SHOULD_NOT_HAVE_VARIABLE_MODIFIER);
		MISC.addRule(STMT_SHOULD_BE_REACHABLE);
		MISC.addRule(CANNOT_USE_UNINTIALIZED_TYPE);
		MISC.addRule(CANNOT_USE_INACTIVE_NEED_ACTIVELY);
		MISC.addRule(UNUSED_ACTIVE_NEEDS);
//		MISC.addRule(INVALID_LABEL_DECORATION);
		MISC.addRule(BREAK_NONE_EXIST_LABEL);
		MISC.addRule(CONTINUE_NONE_EXIST_LABEL);
		MISC.addRule(CLASS_BETTER_START_WITH_NONE_CAPITAL_LETTER);
		MISC.addRule(TYPE_NAME_SHOULD_NOT_BE_EMPTY);
		MISC.addRule(DISCOURAGED_NESTED_WITH);
		MISC.addRule(ATTRIBUTOR_SHOULD_NOT_USE_VJ_RUNTIME);
		
		UNIQUENESS.addRule(DUPLICATE_LABEL);
		UNIQUENESS.addRule(DUPLICATE_METHOD);
		UNIQUENESS.addRule(DUPLICATE_PROPERTY);
		UNIQUENESS.addRule(OVERLAP_STATIC_AND_NONE_STATIC_METHOD);
		UNIQUENESS.addRule(OVERLAP_STATIC_AND_NONE_STATIC_PROPERTY);
		UNIQUENESS.addRule(VARIABLE_ALREADY_DEFINED);
//		UNIQUENESS.addRule(WITH_SCOPE_SHOULD_NOT_CONFLICT_LOCAL);
		UNIQUENESS.addRule(OBJECT_LITERAL_SHOULD_HAVE_UNIQUE_KEY);
		UNIQUENESS.addRule(ETYPE_SHOULD_NOT_HAVE_DUP_ENUM_VALUES);
		UNIQUENESS.addRule(PROPERTY_SHOULD_NOT_HIDE_PARENT_PROPERTY);
		
//		ACCESSIBILITY.addRule(PACKAGE_SHOULD_BE_DEFINED);
		ACCESSIBILITY.addRule(PROPERTY_SHOULD_BE_VISIBLE);
		ACCESSIBILITY.addRule(STATIC_PROPERTY_SHOULD_NOT_BE_ACCESSED_FROM_NONE_STATIC_SCOPE);
		ACCESSIBILITY.addRule(NONE_STATIC_PROPERTY_SHOULD_NOT_BE_ACCESSED_FROM_STATIC_SCOPE);
		ACCESSIBILITY.addRule(METHOD_SHOULD_BE_VISIBLE);
		ACCESSIBILITY.addRule(CONSTRUCTOR_SHOULD_BE_VISIBLE);
		ACCESSIBILITY.addRule(STATIC_METHOD_SHOULD_NOT_BE_ACCESSED_FROM_NONE_STATIC_SCOPE);
		ACCESSIBILITY.addRule(NONE_STATIC_METHOD_SHOULD_NOT_BE_ACCESSED_FROM_STATIC_SCOPE);
...
//		
	...
	private void initRuleSets() {
		...
		TYPE_CHECK.setRuleSetDesription("Type incompatiblities");
		...
		VJO_SYNTAX.setRuleSetName("Vjo");
		VJO_SYNTAX.setRuleSetDesription("Vjo Specific");
	...
	private void addRuleSet(IVjoSemanticRuleSet ruleSet){
		if(m_ruleSetMap == null){
			m_ruleSetMap = new HashMap<String, IVjoSemanticRuleSet>();
		}
