...
//import vjo.io.UnsupportedEncodingException;
//
//import vjo.util.regex.Pattern;
import vjo.util.Formatter;
...
//	int o = 0;
//	while (o < count) {
//		int codePoint = codePointAt(o);
//		if (codePoint != toLowerCase(codePoint)) {
//			StringBuilder builder = new StringBuilder(count);
//			builder.append(substring(0, o));
//			if (!"tr".equals(language) && !"az".equals(language) && !"lt".equals(language)) { // not Turkish, Azeri, Lithuanian
//				while (o < count) {
...
//					o++;
//				}
//			} else if ("lt".equals(language)) { // Lithuanian
//				while (o < count) {
//					codePoint = codePointAt(o);
//					if (codePoint == 0x3a3) {
//						builder.append(convertSigma(o));
...
//				"ij\u012f\u0268\u0456\u0458\u1e2d\u1ecb".indexOf(codePoint, 0) != -1)
//			{
//				o++;
//			}
//		} else {
...
public static String valueOf (double value) {
	return vjo.lang.Double.toString (value);
}
...
public static String valueOf (float value) {
	return vjo.lang.Float.toString (value);
}
...
public static String valueOf (int value) {
	return vjo.lang.Integer.toString (value);
}
...
public static String valueOf (long value) {
	return vjo.lang.Long.toString (value);
}
...
/**
 * Splits this String using the supplied regular expression expr.  max controls the number of
 * times that the pattern is applied to the string.
 *
 * @param 		expr		the regular expression used to divide the string
 * @param 		max		the number of times to apply the pattern
