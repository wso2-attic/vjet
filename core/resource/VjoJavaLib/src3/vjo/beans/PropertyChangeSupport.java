...
import vjo.sun.awt.EventListenerAggregate;
...
public class PropertyChangeSupport implements Serializable {
	...
	public void fireIndexedPropertyChange(String propertyName, int index,
		...
		firePropertyChange(new IndexedPropertyChangeEvent(source, propertyName,
	...
	public void fireIndexedPropertyChange(String propertyName, int index,
		...
		fireIndexedPropertyChange(propertyName, index, new Integer(
