...
/*
 * @(#)src/classes/sov/java/net/SocketInputStream.java, net, asdev, 20070119 1.15
 * ===========================================================================
 ...
 * 029584  180401 hpha     Sun 1.3.1 rollup
...
import vjo.io.FileDescriptor;                                      /*ibm@1173*/
...
class SocketInputStream extends FileInputStream
{
	...
	if (length <= 0 || off < 0 || off + length > b.length) {
        ...
        // acquite file descriptor and do the read
