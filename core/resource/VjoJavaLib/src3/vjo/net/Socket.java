...
/*
 * @(#)src/classes/sov/java/net/Socket.java, net, asdev, 20070119 1.24
 * ===========================================================================
 ...
 * 057409.1 060103 stalleyj Dynamic initialisation from socks properties
 * 058586   190303 pabbott  Back out 57409.1 due to jgrinder regression
 * 059681   260303 riclau   Reimplement 57409.1
 * 061862   090603 pabbott  Merge in 1.4.1_03 Sun changes
 * 064147   211003 riclau   1.4.2 merge
 * 081349   211204 stalleyj Change required for 5.0
 * 107044.1 060906 aponniah Removing bind when local port is 0
 *
 * ===========================================================================
 */
...
class Socket {
	...
	try {
		...
		{                                                                   /* ibm@107044.1 */
			InetSocketAddress inetlocalAddr = (InetSocketAddress)localAddr; /* ibm@107044.1 */
			if(inetlocalAddr.getPort() != 0)                                /* ibm@107044.1 */
				bind(localAddr);	    	
		}                                                                   /* ibm@107044.1 */
	    if (address != null)
		connect(address);
