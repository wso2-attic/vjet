...
/*
 * @(#)src/classes/sov/java/net/URLStreamHandler.java, net, asdev, 20070119 1.18
 * ===========================================================================
 ...
 * ------   ----   ------  ----------------------------------------------------
 * 52070.1 270602  banfield enable use of both Windows and URL separators
 * 56111   301002  stalleyj Merge 1.4.1 changes
...
// FIX: should not assume query if opaque
	...
	if (start < limit) {
		...
		isRelPath = true;
		int ind = Math.max(path.lastIndexOf('/'),path.lastIndexOf(File.separatorChar));/*ibm@52070.1*/
		String seperator = "";
