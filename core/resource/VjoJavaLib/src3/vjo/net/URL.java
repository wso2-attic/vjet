...
/*
 * @(#)src/classes/sov/java/net/URL.java, net, asdev, 20070119 1.29
 * ===========================================================================
 ...
 * ------   ----   ------   ----------------------------------------------------
 * 40945.1.1290302 ktsui    windows separator is changed to URL separator
 * 52070.1 270602  banfield enable use of Windows and URL separators by backing
 *                          out fix for 40945.1
 * 056111  301002  stalleyj Merge 1.4.1 changes 
 * 61076.1 090503  riclau   enable https construction in URL object
 * 60245   300603  sgollapa Port number must be between 0(-1) and 0xFFFF
 * 064147  211003  riclau   1.4.2 merge (without SecurityConstants dependency)
 * 064147  221003  riclau   1.4.2 merge (SecurityConstants part)
 * 06772.1 210104  stalleyj Remove incorrect fix for 60245 
 * 079049  261004  stalleyj Merge to 5.0
 * 082370  260105  stalleyj Merge to build 8 
 * 085185  220405  preece   Change to jsse2 
 * 90706.1 090905  cwhite   Call getlastClassLoader instead of getSystemClassLoader
 * =========================================================================== 
 */
...
public final class URL implements java.io.Serializable {
	...
	if (handler == null) {
		...
		// or not.
		if (protocol.equals("https")) {                          /*ibm@61076.1*/
		    packagePrefixList += "com.ibm.net.ssl.www2.protocol"; /*ibm@61076.1*/ /*ibm@85185*/
		} else {                                                 /*ibm@61076.1*/
		...
		while (handler == null &&
			...
			try {
			    ...
			    ClassLoader cl = com.ibm.jvm.ClassLoader.getLastClassLoader(); /*ibm@90706.1*/
			    if (cl != null) {
