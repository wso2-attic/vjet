...
/*
 * @(#)src/classes/sov/java/net/SocksSocketImpl.java, net, asdev, 20070119 1.11
 * ===========================================================================
 ...
 * Change History
 * --------------
 * 104537	karagate	20060712	Socket creation too slow
 */
...
import vjo.io.BufferedOutputStream;
...
class SocksSocketImpl extends PlainSocketImpl implements SocksConsts {
	...
	if (a instanceof InetSocketAddress) {
	    ...
	    // Use getHostString() to avoid reverse lookups -- ibm@104537
	    server = ad.getHostString();  // ibm@104537
	    port = ad.getPort();
	}
    }
...
// 	}
	...
	if (server == null) {
	    ...
	    URI uri = null;
	    // Use getHostString() to avoid reverse lookups -- ibm@104537
	    String host = epoint.getHostString();  // ibm@104537
	    // IPv6 litteral?
		...
		// Use getHostString() to avoid reverse lookups -- ibm@104537
		server = ((InetSocketAddress) p.address()).getHostString();  // ibm@104537
	...
	if (server == null) {
	    ...
	    URI uri = null;
	    // Use getHostString() to avoid reverse lookups -- ibm@104537
	    String host = saddr.getHostString();  // ibm@104537
	    // IPv6 litteral?
