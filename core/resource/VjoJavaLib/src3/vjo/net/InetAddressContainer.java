...
/*
 * @(#)src/classes/sov/java/net/PlainSocketImpl.javam, net, asdev, 20070119 1.6
 * ===========================================================================
 ...
 * 006647  270100 hdmaw    Sun 1.3R
 * 007085  080200 hdmaw    Migrate defect 5056
 * 056111  301002 stalleyj Merge 1.4.1 changes 
 * 061862  090603 pabbott  Merge in 1.4.1_03 Sun changes
 * 062494  070803 vpatil   socketPreClose() crashes AIX SMPs
 * 064147  211003 riclau   1.4.2 merge
 * 079049  251004 stalleyj Merge to 5.0
 * 082867  090205 stalleyj Alter fix for 62494 to use PrivilegedAction
 * 083061  150205 stalleyj Munge this file to make fd fields int/long 
 * 089602  010605 belldav  Fix SO_TIMEOUT fd problems and move closer to Sun
 * 082628.1 070705 belldav move AIX specific dup2 code to native code
 * ===========================================================================
 */
import java.lang.IllegalArgumentException ;

import vjo.io.IOException;
import vjo.io.InterruptedIOException;
