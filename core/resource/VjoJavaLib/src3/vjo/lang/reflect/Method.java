...
/*
 * @(#)src/classes/sov/java/lang/reflect/Method.java, reflect, asdev, 20070119 1.25
 * ===========================================================================
 ...
 * ------  ----   ------   ----------------------------------------------------
 * 064110  220903 nichanir 1.4.0 Reflection Regression - illegalAccessException
 * 064543  271003 nichanir 1.4.2 Sun Merge
 * 066246  161203 preece   Back out merge - do not assume strings are interned.
 * 071341  050404 nichanir Change slot in Field, Method, Constructor to long for J9
 * 082793  070205 nichanir 1.5.0 Sun Merge
 * 087053  150405 nichanir Provide Annotations and Generics Support for J9
 */
...
public final
    ...
    private com.ibm.oti.reflect.Method j9Method; /*ibm@87053*/
	...
	if (obj != null && obj instanceof Method) {
		...
		&& (getName().equals(other.getName()))) {	/*ibm@66246*/
	...
	try {
		vjo.lang.StringBuffer sb = new vjo.lang.StringBuffer();
	...
	try {
		vjo.lang.StringBuilder sb = new vjo.lang.StringBuilder();
	    int mod = getModifiers();
	    if (mod != 0) {
		sb.append(Modifier.toString(mod) + " ");
	    }
	    //MrP - must be java.lang
	    java.lang.reflect.Type[] typeparms = getTypeParameters();
	    if (typeparms.length > 0) {
		boolean first = true;
		sb.append("<");
		    //MrP - must be java.lang
		for(java.lang.reflect.Type typeparm: typeparms) {
		    if (!first)
			sb.append(",");
	    ...
	    //MrP - must be java.lang
	    java.lang.reflect.Type genRetType = getGenericReturnType();
	    ...
	    sb.append(getName() + "(");
	    //MrP - must be java.lang
	    java.lang.reflect.Type[] params = getGenericParameterTypes();
	    for (int j = 0; j < params.length; j++) {
	    ...
	    sb.append(")");
	    //MrP - must be java.lang
	    java.lang.reflect.Type[] exceptions = getGenericExceptionTypes();
	    if (exceptions.length > 0) {
		sb.append(" throws ");
		for (int k = 0; k < exceptions.length; k++) {
	...
	throws IllegalAccessException, vjo.lang.IllegalArgumentException,
    ...
    public <T extends Annotation> T getAnnotation(Class<T> cl) {
        if (j9Method == null) 
		j9Method = new com.ibm.oti.reflect.Method(this);
	return j9Method.getAnnotation(cl);
    }
	...
	if (j9Method == null) 
		j9Method = new com.ibm.oti.reflect.Method(this);
	return j9Method.getDeclaredAnnotations();
    }
    /*ibm@87053 - end*/
	...
	if (j9Method == null) 
		j9Method = new com.ibm.oti.reflect.Method(this);
	return j9Method.getDefaultValue();
    }
    /*ibm@87053 - end*/
	...
	if (j9Method == null) 
		j9Method = new com.ibm.oti.reflect.Method(this);
	return j9Method.getParameterAnnotations();
    }
    /*ibm@87053 - end*/
}
