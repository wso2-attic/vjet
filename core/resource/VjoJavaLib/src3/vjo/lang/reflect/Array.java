...
private static native void setImpl(Object array, int index, Object value) throws IllegalArgumentException, ArrayIndexOutOfBoundsException;
 ...
 *					if the index is out of bounds -- negative or greater than or equal to the array length
 */
public static native void setBoolean(Object array, int index, boolean value) throws IllegalArgumentException, ArrayIndexOutOfBoundsException;
 ...
 *					if the index is out of bounds -- negative or greater than or equal to the array length
 */
public static native void setByte(Object array, int index, byte value) throws IllegalArgumentException, ArrayIndexOutOfBoundsException;
 ...
 *					if the index is out of bounds -- negative or greater than or equal to the array length
 */
public static native void setChar(Object array, int index, char value) throws IllegalArgumentException, ArrayIndexOutOfBoundsException;
 ...
 *					if the index is out of bounds -- negative or greater than or equal to the array length
 */
public static native void setDouble(Object array, int index, double value) throws IllegalArgumentException, ArrayIndexOutOfBoundsException;
 ...
 *					if the index is out of bounds -- negative or greater than or equal to the array length
 */
public static native void setFloat(Object array, int index, float value) throws IllegalArgumentException, ArrayIndexOutOfBoundsException;
 ...
 *					if the index is out of bounds -- negative or greater than or equal to the array length
 */
public static native void setInt(Object array, int index, int value) throws IllegalArgumentException, ArrayIndexOutOfBoundsException;
 ...
 *					if the index is out of bounds -- negative or greater than or equal to the array length
 */
public static native void setLong(Object array, int index, long value) throws IllegalArgumentException, ArrayIndexOutOfBoundsException;
 ...
 *					if the index is out of bounds -- negative or greater than or equal to the array length
 */
public static native void setShort(Object array, int index, short value) throws IllegalArgumentException, ArrayIndexOutOfBoundsException;
}
