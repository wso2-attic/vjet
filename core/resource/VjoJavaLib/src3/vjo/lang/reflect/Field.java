...
/*
 * @(#)src/classes/sov/java/lang/reflect/Field.java, reflect, asdev, 20070119 1.21
 * ===========================================================================
...
class Field extends AccessibleObject implements Member {
    ...
    private com.ibm.oti.reflect.Field j9Field; /*ibm@87053*/
	...
	int mod = getModifiers();
	//MrP - must be java.lang
	java.lang.reflect.Type fieldType = getGenericType();
	return (((mod == 0) ? "" : (Modifier.toString(mod) + " "))
    ...
    public Object get(Object obj)
        throws vjo.lang.IllegalArgumentException, IllegalAccessException
    {
    ...
    public <T extends Annotation> T getAnnotation(Class<T> cl) {
        if (j9Field == null) 
		j9Field = new com.ibm.oti.reflect.Field(this);
	return j9Field.getAnnotation(cl);
    }
    /*ibm@87053 - end*/
	...
	if (j9Field == null) 
		j9Field = new com.ibm.oti.reflect.Field(this);
	return j9Field.getDeclaredAnnotations();
    }
    /*ibm@87053 - end*/
