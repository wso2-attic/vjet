...
/*
 * @(#)src/classes/sov/java/lang/reflect/Proxy.java, reflect, asdev, 20070119 1.14
 * ===========================================================================
 ...
 * ------  ----    ------  ---------------------------------------------------
 * 004767  251199  hdrl    Sun 1.3 rollup - created file
 * 057680  140103  hutchig javadoc: class loaded IN classloader (not BY)
 * 090781  270605  stalleyj Signature failures after 5.0 merge
 *
 * ===========================================================================
 */
...
import vjo.java.util.Collections;
import vjo.java.util.HashMap;
import vjo.java.util.WeakHashMap;

import vjo.java.lang.ref.Reference;
import vjo.java.lang.ref.WeakReference;
