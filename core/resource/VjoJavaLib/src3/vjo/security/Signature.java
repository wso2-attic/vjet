...
/*
 * @(#)src/classes/sov/java/security/Signature.java, security, asdev, 20070119 1.22
 * ===========================================================================
 ...
 * ------  ------ -------- --------------------------------------------------- 
 * 76834   171104 eldergil 5.0 changes 
 * 76910   161204 eldergil 5.0 changes 
 *                        
 * ===========================================================================
 */
...
import vjo.util.Arrays ;
import vjo.util.HashMap ;

import vjo.io.ByteArrayOutputStream;
...
public abstract class Signature extends SignatureSpi {
    ...
    //
    // ibm@76834 Have added the additional RSA Transformations that IBM JVMs have
    //
    // ibm@76910 
    //
    // The NONEwithRSA signature algorithm is defined to perform raw RSA signatures 
    // (PKCS#1 v1.5 but no hashing), which is also available with the Cipher algorithm 
    // "RSA/ECB/PKCS1Padding".
    //
    // The SUN Cipher class checks for a signed provider, but a signed provider is inconvenient
    // and unnecessary for signature operations.
    //
    // The code in the Signature class allows an application to code: Signature.getInstance("NONEwithRSA")
    // to make use of existing providers, that implement Cipher "RSA/ECB/PKCS1Padding", and new providers, 
    // that implement Signature "NONEwithRSA", without extra effort from the application.
    //
    // In the future the CryptoSpec.html should document the "NONEwithRSA" String. 
    //
    private final static List<ServiceId> rsaIds = Arrays.asList(
        new ServiceId[] {
            ...
            new ServiceId("Cipher", "RSA/SSL/PKCS1Padding"),    /*ibm@76834*/
            new ServiceId("Cipher", "RSAforSSL"),               /*ibm@76834*/
            new ServiceId("Cipher", "RSAwithNoPad"),            /*ibm@76834*/ 
        }
    );
    ...
    static {
    	//MrP - Was ConcurrentHashMap
        signatureInfo = new HashMap<String,Boolean>();
        Boolean TRUE = Boolean.TRUE;
        // pre-initialize with values for our SignatureSpi implementations
        //
        // ibm@76910
        //
        // Add the IBM classes that extend SignatureSpi
        // Except:
        // (a) don't add the pkcs11impl classes by default, they will be added
        // dynamically if requested (read the info in the feature)
        // (b) com.ibm.crypto.provider.SHA1withRSA does not extend SignatureSpi
        // (read the info in the feature)
        //
        signatureInfo.put("com.ibm.crypto.provider.SHA1withDSA", TRUE);
        signatureInfo.put("com.ibm.crypto.pkcs11.provider.DatawithDSA", TRUE);
        signatureInfo.put("com.ibm.crypto.fips.provider.SHA1withDSA", TRUE);
        signatureInfo.put("com.ibm.crypto.provider.SHA1withRSA", TRUE);
    }
    ...
    public Object clone() throws java.lang.CloneNotSupportedException {
        if (this instanceof java.lang.Cloneable) {
            return super.clone();
        } else {
