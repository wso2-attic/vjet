...
/*
 * @(#)src/classes/sov/java/security/Security.java, security, asdev, 20070119 1.43
 * ===========================================================================
 ...
 * ------  ------ -------- --------------------------------------------------- 
 * 76914   231004 eldergil Merge in Sun's 1.5.0 security changes
 * 79360   011104 eldergil Add IBM Provider
 *                        
 * ===========================================================================
 */
...
import vjo.io.BufferedInputStream;
import vjo.io.File; 
...
import vjo.util.HashSet ;
import vjo.util.LinkedHashSet ;
import vjo.util.Properties ;

import vjo.java.reflect.Field ;
...
public final class Security {
    ...
    private static void initializeStatic() {
        props.put("security.provider.1", "com.ibm.jsse2.IBMJSSEProvider2");
        props.put("security.provider.2", "com.ibm.crypto.provider.IBMJCE");
        props.put("security.provider.3", "com.ibm.security.jgss.IBMJGSSProvider");
        props.put("security.provider.4", "com.ibm.security.cert.IBMCertPath");
        /* ibm79360
         *
         * Notes on 5.0 Providers:
         *
         * a. The IBM equivalent of sun.security.rsa.SunRsaSign is in IBMJCE Provider 
         * b. IBM's com.ibm.security.sasl.IBMSASL Provider is equivalent to SUN's 
         *    com.sun.security.sasl.Provider 
         *
         */

        props.put("security.provider.5", "com.ibm.security.sasl.IBMSASL"); 
    }
     ...
     * property in the master file of the Cryptographic Service
