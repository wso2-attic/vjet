...
/*
 * @(#)ReplaceableUCharacterIterator.java	1.4 05/11/17
 *
...
public class ReplaceableUCharacterIterator extends UCharacterIterator {
     ...
     */
    public ReplaceableUCharacterIterator(vjo.lang.StringBuffer buf){
        if(buf==null){
            throw new vjo.lang.IllegalArgumentException();
        }
    ...
    public int getText(char[] fillIn, int offset){
        ...
        if(offset < 0 || offset + length > fillIn.length){
            throw new vjo.lang.IndexOutOfBoundsException(vjo.lang.Integer.toString(length));
        }
