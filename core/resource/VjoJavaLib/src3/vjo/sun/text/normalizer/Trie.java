    ...
    */
                   ...
                   DataManipulate  dataManipulate) throws IOException
    {
        ...
        if (!checkHeader(signature)) {
            throw new vjo.lang.IllegalArgumentException("ICU data file error: Trie header authentication failed, please check if you have the most updated ICU data file");
        }
