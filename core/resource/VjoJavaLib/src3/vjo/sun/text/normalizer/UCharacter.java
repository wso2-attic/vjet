...
{ 
            ...
            if (isNotExceptionIndicator(props)) {
                ...
                if (PROPERTY_.hasExceptionValue(index, 
                    ...
                    if (num >= NUMERATOR_POWER_LIMIT_) {
                        num &= 0xff;
                        // 10^x without math.h
                        numerator = vjo.lang.Math.pow(10, num);
                    } 
                    else {
                        numerator = num;
                    }
    ...
    public static int getCodePoint(char lead, char trail) 
    {
        ...
        throw new vjo.lang.IllegalArgumentException("Illegal surrogate characters");
    }
    ...
    {
        int          size   = str.length();
        vjo.lang.StringBuffer result = new vjo.lang.StringBuffer(size);
        int          offset  = 0;
        int          ch;
    ...
    public static VersionInfo getAge(int ch) 
    {
        ...
        throw new vjo.lang.IllegalArgumentException("Codepoint out of bounds");
        }
            ...
            try { // using try for < 0 ch is faster than using an if statement
                return PROPERTY_DATA_[
                      PROPERTY_TRIE_DATA_[
                              ...
                              + (ch & 0x1f)]];
            } catch (vjo.lang.ArrayIndexOutOfBoundsException e) {
