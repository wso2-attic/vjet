...
/*
 * @(#)src/classes/sov/java/text/DateFormatSymbols.java, i18n, asdev, 20070119 1.18
 * ===========================================================================
 ...
 * ------  ----   ------    -------------------------------------------------- 
 * 97531   091105 corbin    LIR305 Performance Enhancement
 * 98270   121205 corbin    Fix JCK failure as a result of above change
 * 98787   040106 smithwil  Refix JCK failure caused by LIR305
 *
 */
...
import vjo.java.util.WeakHashMap;

import vjo.java.sun.text.Utility;
...
public class DateFormatSymbols implements Serializable, Cloneable {
    ...
    /**
     * cache to hold zoneIndex to prevent long array searches.
     * for details, see LIR305
     */
    private static WeakHashMap zoneIndexCache = new WeakHashMap();  //ibm.97531
    ...
    {
      //ibm.97531 starts
      Integer i = (Integer)zoneIndexCache.get(ID);

      if(i != null) {
          //ibm.98270 ibm@98787 start
          // double check zoneStrings in case data has been changed
          int cached_index = i.intValue();
          if ( cached_index < zoneStrings.length
                  && ID.equalsIgnoreCase(zoneStrings[cached_index][0])) {
              return cached_index;
          }
          //ibm.98270 ibm@98787 end
      }
      //ibm.97531 ends
      ...
      for (int index=0; index<zoneStrings.length; index++)
      {
          if (ID.equalsIgnoreCase(zoneStrings[index][0])) { 
              zoneIndexCache.put(ID,new Integer(index));    //ibm.97531
              return index;   
          }                                                 
      }
