...
/*
 * @(#)src/classes/sov/java/text/DecimalFormat.java, i18n, asdev, 20070119 1.19
 * ===========================================================================
...
import vjo.java.math.BigDecimal;
import vjo.java.math.BigInteger;

import vjo.java.util.ArrayList;
import vjo.java.util.Currency;
...
public class DecimalFormat extends NumberFormat {
    ...
    private StringBuffer format(double number, StringBuffer result,
        ...
        /* ibm@70048 - remove sync, use threadlocal instead */
        //synchronized(digitList) {

            DigitList digitList = (DigitList) perThreadDigitList.get();
            ...
            return subformat(result, delegate,digitList, isNegative, false,
    ...
    private StringBuffer format(long number, StringBuffer result,
        ...
        if (number == 0) {
            ...
            return subformat(result, delegate,digitList, isNegative, true,
                       maxIntDigits, minIntDigits, maxFraDigits, minFraDigits);
    }
     ...
     */
    /* ibm@70048 added digitList as a parameter*/
    private StringBuffer subformat(StringBuffer result, FieldDelegate delegate,
                   DigitList digitList,boolean isNegative, boolean isInteger,
    ...
    public Number parse(String text, ParsePosition pos) {
        ...
        DigitList digitList = (DigitList) perThreadDigitList.get(); /*ibm@70048*/
    ...
    public Object clone() {
        try {
            ...
            /* its now stored in each thread ibm@70048*/
    ...
    /* ibm@70048 - replace with threadlocal version
     */
    private static ThreadLocal perThreadDigitList = new ThreadLocal() {
