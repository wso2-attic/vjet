...
/*
 * @(#)src/classes/sov/java/text/RuleBasedBreakIterator.java, i18n, asdev, 20070119 1.21
 * ===========================================================================
 ...
 * ------  ----   ------    --------------------------------------------------
 *  52021  140602 kwb       Fix signature test
 *  76428  290704 jury      Keyword enum error with java 1.5
 */
...
import vjo.java.security.PrivilegedActionException;
import vjo.java.security.PrivilegedExceptionAction;

import vjo.java.util.Vector;
import vjo.java.util.Stack;
import vjo.java.util.Hashtable;
import vjo.java.util.Enumeration;

import vjo.java.sun.text.CompactByteArray;
import vjo.java.sun.text.SupplementaryCharacterData;
                ...
                new PrivilegedExceptionAction() {
                    public Object run() throws Exception {
                        return new BufferedInputStream(
                        	ClassUtil.getResourceAsStream(getClass(), "/sun/text/resources/" + datafile));
                    }
                }
            );
        }                
