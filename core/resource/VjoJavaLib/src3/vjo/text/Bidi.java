...
/*
 * @(#)src/classes/sov/java/text/Bidi.java, core, asdev, 20070119 1.11
 * ===========================================================================
...
/*
 *  @(#)Bidi.java       1.8 01/06/25
 *
 *
 *  60261  corbin  25/04/03    Add extra error check to constructor
 *  64296  corbin  100903      Intergate 1.4.2 version
 *  78059  corbin  240804      Integrate 5.0 version
 *
 */
...
import vjo.java.awt.font.TextAttribute;
import vjo.java.awt.font.NumericShaper;
import vjo.java.sun.text.CodePointIterator;
...
public final class Bidi {
    ...
    static {
        vjo.security.AccessController.doPrivileged(
            new vjo.sun.security.action.LoadLibraryAction("awt"));
        vjo.security.AccessController.doPrivileged(
            new vjo.sun.security.action.LoadLibraryAction("fontmanager"));
    }
...
//MrP - No native in VjO
//    private static native int nativeGetDirectionCode(int cp);
    private static int nativeGetDirectionCode(int cp) {
//MrP - ??? Need to make this actually work vs. just hardcoding
...
//                                                            int length, int flags);
    private static synchronized void nativeBidiChars(Bidi bidi, char[] text, int textStart,
            byte[] embeddings, int embeddingStart,
            int length, int flags)
    {
