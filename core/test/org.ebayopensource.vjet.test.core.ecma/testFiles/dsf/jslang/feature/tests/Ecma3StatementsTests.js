vjo.ctype("dsf.jslang.feature.tests.Ecma3StatementsTests")
...
this.reportCompare(expect, actual, 'for-in custom object');
...
this.reportCompare(expect, actual, 'for-in function expression');

},
//-----------------------------------------------------------------------------
test_regress__121744:function(){
...
this.reportCompare(expect, actual, summary + ': shortSwitch');
...
this.reportCompare(expect, actual, summary + ': longSwitch');
...
//-----------------------------------------------------------------------------
test_regress__74474__001:function(){
...
//-----------------------------------------------------------------------------
test_regress__74474__002:function(){
...
//-----------------------------------------------------------------------------
test_regress__74474__003:function(){
...
//-----------------------------------------------------------------------------
test_regress__83532__001:function(){
...
//-----------------------------------------------------------------------------
test_regress__83532__002:function(){
