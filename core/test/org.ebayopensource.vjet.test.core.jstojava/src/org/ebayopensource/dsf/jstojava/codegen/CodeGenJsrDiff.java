...
//	private String gold = null;
	...
	public static Collection<Object[]> data() {
		return Arrays.asList( new Object[][] {
			...
			//2-Don't forget to hit F5 on typespacesrc before running your test	
			{"CTypeOnlyNoPackage",
...
//			 FOLDER+"/CTypeWithITypeJsr.jsr"}, - commented for running tests from jars
...
//			 FOLDER + "/ETypeComplexJsr.jsr" }, - commented for running tests from jars
//		TODO	 
...
//			 FOLDER + "/CTypeWithMTypePropsJsr.jsr" },
			 ...
			 {"vjo.a.b.CTypeOnly00",
			  FOLDER + "/CTypeOnly00Jsr.jsr"},
				  
			 {"vjo.g.h.ITypeOnly00",
			  FOLDER + "/ITypeOnly00Jsr.jsr"},
...
/* embedded space in var args		  
             {FOLDER + "/CTypePropsMethodsArgs02b",
			  FOLDER + "/CTypePropsMethodsArgs02bJsr.jsr"},
*/			  
...
//			  FOLDER + "/ExtendsATypeWithATypeJsr.jsr" }, - commented for running tests from jars
			  
//			 {"org.ebayopensource.dsf.jstojava.codegen.data.ExtendsATypeWithATypeImplementsBothITypes",
//			  FOLDER + "/ExtendsATypeWithATypeImplementsBothITypesJsr.jsr" },- commented for running tests from jars
			  
//			 {"org.ebayopensource.dsf.jstojava.codegen.data.ExtendsATypeWithATypeImplementsIType",
//			  FOLDER + "/ExtendsATypeWithATypeImplementsITypeJsr.jsr" },- commented for running tests from jars
			  
//			 {"org.ebayopensource.dsf.jstojava.codegen.data.ExtendsCTypeWithAType",
//			  FOLDER + "/ExtendsCTypeWithATypeJsr.jsr" },- commented for running tests from jars
			  
//			 {"org.ebayopensource.dsf.jstojava.codegen.data.ExtendsCTypeWithATypeImplementsBothITypes",
//			  FOLDER + "/ExtendsCTypeWithATypeImplementsBothITypesJsr.jsr" },- commented for running tests from jars
			  
//			 {"org.ebayopensource.dsf.jstojava.codegen.data.ExtendsCTypeWithATypeImplementsIType",
//			  FOLDER + "/ExtendsCTypeWithATypeImplementsITypeJsr.jsr" },- commented for running tests from jars
			  
//			 {"org.ebayopensource.dsf.jstojava.codegen.data.ExtendsCTypeWithCType",
//			  FOLDER + "/ExtendsCTypeWithCTypeJsr.jsr" },- commented for running tests from jars
			  
//			 {"org.ebayopensource.dsf.jstojava.codegen.data.ExtendsCTypeWithCTypeImplementsBothITypes",
//			  FOLDER + "/ExtendsCTypeWithCTypeImplementsBothITypesJsr.jsr" },- commented for running tests from jars
			  
//		     {"org.ebayopensource.dsf.jstojava.codegen.data.ExtendsCTypeWithCTypeImplementsIType",
//			  FOLDER + "/ExtendsCTypeWithCTypeImplementsITypeJsr.jsr" },- commented for running tests from jars
			  
//			 {"org.ebayopensource.dsf.jstojava.codegen.data.ExtendsITypeWithBothITypes",
//			  FOLDER + "/ExtendsITypeWithBothITypesJsr.jsr" },- commented for running tests from jars
			  
//			 {"org.ebayopensource.dsf.jstojava.codegen.data.ExtendsITypeWithIType",
//			  FOLDER + "/ExtendsITypeWithITypeJsr.jsr" },- commented for running tests from jars
			  
//			 {"org.ebayopensource.dsf.jstojava.codegen.data.ImplementsATypeWithBothITypes",
//			  FOLDER + "/ImplementsATypeWithBothITypesJsr.jsr" },- commented for running tests from jars
			  
//			 {"org.ebayopensource.dsf.jstojava.codegen.data.ImplementsATypeWithIType",
//			  FOLDER + "/ImplementsATypeWithITypeJsr.jsr" },- commented for running tests from jars
			  
//			 {"org.ebayopensource.dsf.jstojava.codegen.data.ImplementsCTypeWithBothITypes",
//			  FOLDER + "/ImplementsCTypeWithBothITypesJsr.jsr" },- commented for running tests from jars
			  
//			 {"org.ebayopensource.dsf.jstojava.codegen.data.ImplementsCTypeWithIType",
//			  FOLDER + "/ImplementsCTypeWithITypeJsr.jsr" },- commented for running tests from jars
...
//			  FOLDER + "/CTypeCustomTypeJsr.jsr" },
	...
	public static void setUp() throws Exception {
		...
		mgr = s_controller.loadTypes("CodeGenJsrDiff", s_groupPath, "workspaceTS/src");
	}
	...
	private static String getGroupPath() {
		...
		URL url = CodeGenJsrDiff.class.getClassLoader().getResource(srcPath + "data/AType.vjo");
	...
	public String generateTestString(String inputFileName) throws Exception {
		IJstType type = mgr.getTypeSpace().getGroup("CodeGenJsrDiff").getEntity(inputFileName);
		StringWriter buffer = new StringWriter();
		JsrGenerator generator = new JsrGenerator(new PrintWriter(buffer), CodeStyle.PRETTY);
	...
	public void verifyStrings() throws IOException {
		...
		try {
			...
			System.err.println("This file " + m_input + " should not throw Exception "
		...
		URL url = CodeGenJsrDiff.class.getClassLoader().getResource(srcPath + m_gold);
