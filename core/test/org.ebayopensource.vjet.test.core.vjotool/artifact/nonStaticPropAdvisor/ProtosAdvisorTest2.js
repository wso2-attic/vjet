vjo.ctype('nonStaticPropAdvisor.ProtosAdvisorTest2')
...
.protos({
    ...
    //>private void priFunction(String arg1, String arg2)
    priFunction :  function (arg1, arg2) {
...
.props({
	...
	testFunction : function(){ //<private void testFunction()
		this.testFunction();
		var xx = null; 
	}
})
