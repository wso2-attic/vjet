...
static String PROJECT_ARTIFACT_ID = "repositoryeditor.tests.project.artifact";
...
IFixtureDefManager defManager = new IFixtureDefManager() {
	...
	IArtifactDef sampleProjectArtifact = new IArtifactDef() {
		...
		public Map<String, String> getArtifactAttributes() {
			...
			if (m_artifactAttributes == null) {
				...
				m_artifactAttributes.put("testBundleId", "org.ebayopensource.vjet.testframework.test");
				m_artifactAttributes.put("projectName", PROJECT_ARTIFACT_ID);
			}
			return m_artifactAttributes;
		}

		public String getArtifactId() {
			return "org.ebayopensource.vjet.testframework.artifact.project";
		}};
	/***************************************************/
	...
	IFixtureDef sampleFixture2 = new IFixtureDef() {
		...
		public String getFixtureId() {
			return "com.ebay.tools.testframework.fixture2";
		}};
	/***************************************************/
