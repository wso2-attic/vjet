 ...
 *
 *******************************************************************************/
package org.ebayopensource.vjet.eclipse.test.core.contentassist;
...
//			int position = lastPositionInFile("  function", mname);
...
//			int position = lastPositionInFile("	foreach", mname);
//			basicTemplateTest(mname, position, names);
//
//		} finally {
//			if (m_fixtureManager != null) {
