...
public interface IInternalRefactoringProcessorIds {
	...
	/**
	 * Processor ID of the copy processor (value <code>"org.eclipse.dltk.mod.ui.CopyProcessor"</code>).
	 * 
	 ...
	 *
	 */
	public static String COPY_PROCESSOR= "org.eclipse.dltk.mod.ui.CopyProcessor";  //$NON-NLS-1$
