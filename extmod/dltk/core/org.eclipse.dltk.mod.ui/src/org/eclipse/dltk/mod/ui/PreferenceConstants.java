...
public class PreferenceConstants {
	...
	// /**
	// * Preference key suffix that controls if semantic highlighting is
	// enabled.
	// *
	// * <p>
	 ...
	 * </p>
	 */
	public static final String LINK_TYPEHIERARCHY_TO_EDITOR = "org.eclipse.dltk.mod.ui.packages.linktypehierarchytoeditor"; //$NON-NLS-1$
	...
	public static final String APPEARANCE_FOLD_PACKAGES_IN_PACKAGE_EXPLORER = "org.eclipse.dltk.mod.ui.flatPackagesInPackageExplorer";//$NON-NLS-1$

	public static final String SHOW_SOURCE_MODULE_CHILDREN = "org.eclipse.dltk.mod.ui.packages.cuchildren"; //$NON-NLS-1$

	public static final String APPEARANCE_METHOD_RETURNTYPE = "org.eclipse.dltk.mod.ui.methodreturntype";//$NON-NLS-1$
	public static final String APPEARANCE_METHOD_TYPEPARAMETERS = "org.eclipse.dltk.mod.ui.methodtypeparametesr";//$NON-NLS-1$
	public static final String APPEARANCE_COMPRESS_PACKAGE_NAMES = "org.eclipse.dltk.mod.ui.compresspackagenames";//$NON-NLS-1$
	public static final String APPEARANCE_PKG_NAME_PATTERN_FOR_PKG_VIEW = "org.eclipse.dltk.mod.ui.PackagesView.pkgNamePatternForPackagesView";//$NON-NLS-1$
	public static final String LINK_PACKAGES_TO_EDITOR = "org.eclipse.dltk.mod.ui.packages.linktoeditor"; //$NON-NLS-1$
	 ...
	 * 
	 */
	public static final String ID_BESTMATCH_HOVER = "org.eclipse.dltk.mod.ui.BestMatchHover"; //$NON-NLS-1$
	...
	public static void initializeDefaultValues(IPreferenceStore store,
		...
		// link with editor
		store.setDefault(PreferenceConstants.LINK_BROWSING_MEMBERS_TO_EDITOR,
				true);
		store.setDefault(PreferenceConstants.LINK_BROWSING_PACKAGES_TO_EDITOR,
				true);
		store.setDefault(PreferenceConstants.LINK_BROWSING_PROJECTS_TO_EDITOR,
				true);
		store.setDefault(PreferenceConstants.LINK_BROWSING_TYPES_TO_EDITOR,
				true);
		...
		store
				.setDefault(
						...
						"org.eclipse.dltk.mod.ui.spellingProposalCategory:65545\0org.eclipse.dltk.mod.ui.scriptTypeProposalCategory:65540\0org.eclipse.dltk.mod.ui.scriptNoTypeProposalCategory:65539\0org.eclipse.dltk.mod.ui.textProposalCategory:65541\0org.eclipse.dltk.mod.ui.templateProposalCategory:2\0"); //$NON-NLS-1$
		...
		store.setDefault(PreferenceConstants.CODEASSIST_SORTER,
				"org.eclipse.dltk.mod.ui.RelevanceSorter"); //$NON-NLS-1$
		...
		store
				.setDefault(
						...
						"org.eclipse.dltk.mod.ui.BestMatchHover;0;org.eclipse.dltk.mod.ui.ScriptSourceHover;" + sourceHoverModifierName); //$NON-NLS-1$
		store
				.setDefault(
						PreferenceConstants.EDITOR_TEXT_HOVER_MODIFIER_MASKS,
						"org.eclipse.dltk.mod.ui.BestMatchHover;0;org.eclipse.dltk.mod.ui.ScriptSourceHover;" + sourceHoverModifier); //$NON-NLS-1$
	 ...
	 */
	public static final String TYPEFILTER_ENABLED = "org.eclipse.dltk.mod.ui.typefilter.enabled"; //$NON-NLS-1$
	public static final String METHODFILTER_ENABLED = "org.eclipse.dltk.mod.ui.methodfilter.enabled"; //$NON-NLS-1$

	public static final String LINK_BROWSING_MEMBERS_TO_EDITOR = "org.eclipse.dltk.mod.ui.browsing.member.to.editor"; //$NON-NLS-1$
	public static final String LINK_BROWSING_PROJECTS_TO_EDITOR = "org.eclipse.dltk.mod.ui.browsing.projects.to.editor"; //$NON-NLS-1$
	public static final String LINK_BROWSING_PACKAGES_TO_EDITOR = "org.eclipse.dltk.mod.ui.browsing.packages.to.editor"; //$NON-NLS-1$
	public static final String LINK_BROWSING_TYPES_TO_EDITOR = "org.eclipse.dltk.mod.ui.browsing.types.to.editor"; //$NON-NLS-1$
	...
	public static final String APPEARANCE_DOCUMENTATION_FONT = "org.eclipse.dltk.mod.ui.documentationFont"; //$NON-NLS-1$
}
