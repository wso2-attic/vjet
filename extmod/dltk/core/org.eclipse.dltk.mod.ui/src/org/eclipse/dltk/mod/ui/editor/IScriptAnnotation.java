...
public interface IScriptAnnotation {
	 ...
	 * annotation is set or <code>null</code> if no corresponding compilation
	 * unit exists.
	 */
	ISourceModule getSourceModule();

	/**
	 * Returns the problem arguments or <code>null</code> if no problem
	...
	/**
	 * Returns the problem id or <code>-1</code> if no problem id can be
	 * evaluated.
	 * 
	 ...
	 * <code>null<code> if no marker type
