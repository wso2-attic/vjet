...
public class FiltersDialog extends SelectionStatusDialog {
	...
	public FiltersDialog(DLTKSearchResultPage page) {
		...
		setTitle(org.eclipse.dltk.mod.internal.ui.search.SearchMessages.FiltersDialog_title); 
	...
	private void createTableLimit(Composite ancestor) {
		...
		fLimitElementsCheckbox.setText(org.eclipse.dltk.mod.internal.ui.search.SearchMessages.FiltersDialog_limit_label);  
	...
	protected void validateText() {
		...
		if (fLimitElementsCheckbox.getSelection() && value <= 0)
			updateStatus(new Status(IStatus.ERROR, DLTKUIPlugin.getPluginId(), 0, org.eclipse.dltk.mod.internal.ui.search.SearchMessages.FiltersDialog_limit_error, null)); 
		else
