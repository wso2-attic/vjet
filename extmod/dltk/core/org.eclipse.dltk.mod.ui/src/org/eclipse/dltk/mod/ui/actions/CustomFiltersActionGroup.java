...
import org.eclipse.dltk.mod.internal.ui.filters.FilterMessages;
import org.eclipse.dltk.mod.internal.ui.filters.NamePatternFilter;
	...
	private void initializeWithPluginContributions() {
		...
		for (int i= 0; i < filterDescs.length; i++) {
			...
			if (fEnabledFilterIds.containsKey(id)) {
				//XXX: dltk logging?
				//DLTKUIPlugin.logErrorMessage("WARNING: Duplicate id for extension-point \"org.eclipse.dltk.mod.ui.modelElementFilters\""); //$NON-NLS-1$
			}
