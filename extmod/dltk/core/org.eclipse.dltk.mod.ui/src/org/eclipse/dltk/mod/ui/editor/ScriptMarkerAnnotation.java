...
public class ScriptMarkerAnnotation extends MarkerAnnotation implements IScriptAnnotation {
	...
	public static final String DLTK_MARKER_TYPE_PREFIX= "org.eclipse.dltk.mod"; //$NON-NLS-1$
	public static final String ERROR_ANNOTATION_TYPE= "org.eclipse.dltk.mod.ui.error"; //$NON-NLS-1$
	public static final String WARNING_ANNOTATION_TYPE= "org.eclipse.dltk.mod.ui.warning"; //$NON-NLS-1$
	public static final String INFO_ANNOTATION_TYPE= "org.eclipse.dltk.mod.ui.info"; //$NON-NLS-1$
