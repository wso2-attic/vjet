...
public class OpenViewActionGroup extends ActionGroup {
	...
	public OpenViewActionGroup(IViewPart part, ISelectionProvider selectionProvider) {
		...
		fIsTypeHiararchyViewerOwner= "org.eclipse.dltk.mod.internal.ui.typehierarchy.TypeHierarchyViewPart".equals(partName); //$NON-NLS-1$
		fIsCallHiararchyViewerOwner= "org.eclipse.dltk.mod.internal.ui.callhierarchy.CallHierarchyViewPart".equals(partName); //$NON-NLS-1$
	}
