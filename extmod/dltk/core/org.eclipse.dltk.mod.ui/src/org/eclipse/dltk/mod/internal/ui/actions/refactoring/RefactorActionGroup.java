...
public class RefactorActionGroup extends ActionGroup {
	...
	private static final String PERF_REFACTOR_ACTION_GROUP= "org.eclipse.dltk.mod.ui/perf/explorer/RefactorActionGroup"; //$NON-NLS-1$

	/**
	 * Pop-up menu: id of the refactor sub menu (value <code>org.eclipse.dltk.mod.ui.refactoring.menu</code>).
	 * 
	 *
	 */
	public static final String MENU_ID= "org.eclipse.dltk.mod.ui.refactoring.menu"; //$NON-NLS-1$
...
//	private static final String QUICK_MENU_ID= "org.eclipse.dltk.mod.ui.edit.text.script.refactor.quickMenu"; //$NON-NLS-1$
