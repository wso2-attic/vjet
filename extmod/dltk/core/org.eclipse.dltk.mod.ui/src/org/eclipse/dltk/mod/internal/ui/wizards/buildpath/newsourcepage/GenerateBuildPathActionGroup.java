...
public class GenerateBuildPathActionGroup extends ActionGroup {
    /**
     * Pop-up menu: id of the source sub menu (value <code>org.eclipse.dltk.mod.ui.buildpath.menu</code>).
     * 
	 *
     */
    public static final String MENU_ID= "org.eclipse.dltk.mod.ui.buildpath.menu"; //$NON-NLS-1$
