 ...
 * "org.eclipse.dltk.mod.dltkElementFilters" extension point.
 * 
 */
public class FilterDescriptor implements Comparable, IPluginContribution {
	...
	private FilterDescriptor(IConfigurationElement element) {
		...
		Assert.isTrue(isPatternFilter() ^ isCustomFilter(), "An extension for extension-point org.eclipse.dltk.mod.ui.dltkElementFilters does not specify a correct filter"); //$NON-NLS-1$
		Assert.isNotNull(getId(), "An extension for extension-point org.eclipse.dltk.mod.ui.dltkElementFilters does not provide a valid ID"); //$NON-NLS-1$
		Assert.isNotNull(getName(), "An extension for extension-point org.eclipse.dltk.mod.ui.dltkElementFilters does not provide a valid name"); //$NON-NLS-1$
	}
