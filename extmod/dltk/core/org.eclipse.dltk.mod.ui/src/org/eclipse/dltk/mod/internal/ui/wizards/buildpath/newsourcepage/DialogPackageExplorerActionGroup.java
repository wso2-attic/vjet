...
import org.eclipse.dltk.mod.internal.corext.buildpath.AddSelectedSourceFolderOperation;
...
import org.eclipse.dltk.mod.internal.corext.buildpath.CreateFolderOperation;
import org.eclipse.dltk.mod.internal.corext.buildpath.EditFiltersOperation;
import org.eclipse.dltk.mod.internal.corext.buildpath.ExcludeOperation;
...
import org.eclipse.dltk.mod.internal.corext.buildpath.LinkedSourceFolderOperation;
import org.eclipse.dltk.mod.internal.corext.buildpath.PackageExplorerActionEvent;
import org.eclipse.dltk.mod.internal.corext.buildpath.RemoveFromBuildpathOperation;
import org.eclipse.dltk.mod.internal.corext.buildpath.ResetAllOperation;
import org.eclipse.dltk.mod.internal.corext.buildpath.UnexcludeOperation;
 ...
 * 
 * @see org.eclipse.dltk.mod.internal.corext.buildpath.AddSelectedSourceFolderOperation
 * @see org.eclipse.dltk.mod.internal.corext.buildpath.RemoveFromBuildpathOperation
 * @see org.eclipse.dltk.mod.internal.corext.buildpath.IncludeOperation
 * @see org.eclipse.dltk.mod.internal.corext.buildpath.UnincludeOperation
 * @see org.eclipse.dltk.mod.internal.corext.buildpath.ExcludeOperation
 * @see org.eclipse.dltk.mod.internal.corext.buildpath.UnexcludeOperation
 * @see org.eclipse.dltk.mod.internal.corext.buildpath.EditFiltersOperation
 * @see org.eclipse.dltk.mod.internal.corext.buildpath.ResetOperation
 */
...
//            return FILE;
    ...
    /* (non-Javadoc)
     * @see org.eclipse.dltk.mod.internal.ui.actions.CompositeActionGroup#dispose()
     */
    public void dispose() {
        fListeners.clear();
        super.dispose();
