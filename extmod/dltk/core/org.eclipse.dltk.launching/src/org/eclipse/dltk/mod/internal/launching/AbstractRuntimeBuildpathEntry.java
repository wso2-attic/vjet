...
public abstract class AbstractRuntimeBuildpathEntry extends PlatformObject implements IRuntimeBuildpathEntry2 {
	 ...
	 * Subclasses should override if required.
	 * 
	 * @see org.eclipse.dltk.mod.internal.launching.IRuntimeBuildpathEntry2#isComposite()
	 */
	 ...
	 * Subclasses should override if required.
	 * 
	 * @see org.eclipse.dltk.mod.internal.launching.IRuntimeBuildpathEntry2#getRuntimeBuildpathEntries()
	 */
	 ...
	 * node.
	 * 
	 * @see org.eclipse.dltk.mod.launching.IRuntimeBuildpathEntry#getMemento()
	 */
	 ...
	 * Subclasses should override if required.
	 * 
	 * @see org.eclipse.dltk.mod.launching.IRuntimeBuildpathEntry#getPath()
	 */
	 ...
	 * Subclasses should override if required.
	 * 
	 * @see org.eclipse.dltk.mod.launching.IRuntimeBuildpathEntry#getResource()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.dltk.mod.launching.IRuntimeBuildpathEntry#getBuildpathProperty()
	 */
	public int getBuildpathProperty() {
		return buildpathProperty;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.dltk.mod.launching.IRuntimeBuildpathEntry#setBuildpathProperty(int)
	 */
	 ...
	 * Subclasses should override if required.
	 * 
	 * @see org.eclipse.dltk.mod.launching.IRuntimeBuildpathEntry#getLocation()
	 */
	 ...
	 * Subclasses should override if required.
	 * 
	 * @see org.eclipse.dltk.mod.launching.IRuntimeBuildpathEntry#getBuildpathEntry()
	 */
	public IBuildpathEntry getBuildpathEntry() {
		return null;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.dltk.mod.launching.IRuntimeBuildpathEntry#getScriptProject()
	 */
