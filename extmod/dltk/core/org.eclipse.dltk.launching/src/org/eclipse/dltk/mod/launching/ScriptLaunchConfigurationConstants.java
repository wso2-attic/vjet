...
public class ScriptLaunchConfigurationConstants {
	...
	/**
	 * whether run build before launch or not
	 */
	public static final String ATTR_BUILD_BEFORE_LAUNCH = "buildBeforeLaunch"; //$NON-NLS-1$

	/**
	 * whether run 'java2js' before launch or not
	 */
	public static final String ATTR_JAVA2JS_BEFORE_LAUNCH = "java2jsBeforeLaunch"; //$NON-NLS-1$
	...
	public static final String ATTR_DLTK_DBGP_STRIP_SOURCE_FOLDERS = "stripSourceFolders"; //$NON-NLS-1$
	...
	public static final String ATTR_DEBUG_CONSOLE = DLTKLaunchingPlugin.PLUGIN_ID
			+ Messages.ScriptLaunchConfigurationConstants_2;
