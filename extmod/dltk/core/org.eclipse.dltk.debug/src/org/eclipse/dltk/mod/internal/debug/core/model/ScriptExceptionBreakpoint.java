...
public class ScriptExceptionBreakpoint extends AbstractScriptBreakpoint
	...
	private static final String SCRIPT_EXCEPTION_BREAKPOINT = "org.eclipse.dltk.mod.debug.scriptExceptionBreakpointMarker"; //$NON-NLS-1$
	 ...
	 * (value <code>"org.eclipse.dltk.mod.debug.core.caught"</code>). This attribute is stored as a <code>boolean</code>.
	 ...
	 * (value <code>"org.eclipse.dltk.mod.debug.core.uncaught"</code>). This attribute is stored as a
	...
	/* (non-Javadoc)
	 * @see org.eclipse.dltk.mod.debug.core.IJavaExceptionBreakpoint#setSuspendOnSubclasses(boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.dltk.mod.debug.core.IJavaExceptionBreakpoint#isSuspendOnSubclasses()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.dltk.mod.debug.core.IJavaExceptionBreakpoint#getExceptionTypeName()
	 */
