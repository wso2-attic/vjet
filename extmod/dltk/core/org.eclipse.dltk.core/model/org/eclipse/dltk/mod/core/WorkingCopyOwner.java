 ...
 * owner is used to identify a working copy and to create its buffer.
 * <p>
 ...
 * <code>IType.resolveType(String, WorkingCopyOwner)</code>. Clients can also
 * override the default implementation of
 * <code>createBuffer(ISourceModule)</code>.
 * </p>
 * <p>
 * Note: even though this class has no abstract method, which means that it
 * provides functional default behavior, it is still an abstract class, as
...
public abstract class WorkingCopyOwner {
	 ...
	 * <code>createBuffer(ISourceModule)</code> method is used by the primary
	 * working copy owner. It doesn't replace the internal primary working
	 * owner.
	 * <p>
	 * This method is for internal use by the dltk-related plug-ins. Clients
	 * outside of the dltk should not reference this method.
	 * </p>
	 * 
	 ...
	 * 
	 * @param name
	 *            the name of the working copy (e.g. "X.java")
	 * @param buildpath
	...
	public final ISourceModule newWorkingCopy(String name,
		...
		// this);
		ISourceModule result = ((ScriptFolder) parent).createSourceModule(name,
				this);
		// EBAY - START MOD
