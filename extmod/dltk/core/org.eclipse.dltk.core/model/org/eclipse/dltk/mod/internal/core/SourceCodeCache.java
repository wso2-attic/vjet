...
public class SourceCodeCache implements IFileCacheManagement {
	...
	private static final String ID = "org.eclipse.dltk.mod.core.fileCache.default"; //$NON-NLS-1$

	/*
	 * @see org.eclipse.dltk.mod.internal.core.ISourceCodeCache#getId()
	 */
	public String getId() {
		return ID;
	}
	...
	public char[] get(IFile file) throws ModelException {
		...
		final char[] result;
		try {
			result = org.eclipse.dltk.mod.compiler.util.Util
