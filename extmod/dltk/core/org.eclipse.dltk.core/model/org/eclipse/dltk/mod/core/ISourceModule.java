...
/**
 * Represents an entire source module (source file). Module elements need to be
 * opened before they can be navigated or manipulated. The children appear in
 * the order in which they are declared in the source. If a file cannot be
 * parsed, its structure remains unknown. Use
