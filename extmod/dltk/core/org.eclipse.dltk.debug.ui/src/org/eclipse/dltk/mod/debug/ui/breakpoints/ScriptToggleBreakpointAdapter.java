...
public abstract class ScriptToggleBreakpointAdapter implements
	...
	protected boolean isRemote(IWorkbenchPart part, ISelection selection) {
		if (selection instanceof IStructuredSelection) {
			...
			if (element instanceof IMember) {
				...
				if (member.getScriptProject().getProject() == null)
					return true;
				else
	...
	/**
	 * Returns a list of <code>IField</code> and
	 * <code>IJavaFieldVariable</code> in the given selection. When an
	 * <code>IField</code> can be resolved for an
	 * <code>IJavaFieldVariable</code>, it is returned in favour of the
	 * variable.
	 * 
	 * @param selection
