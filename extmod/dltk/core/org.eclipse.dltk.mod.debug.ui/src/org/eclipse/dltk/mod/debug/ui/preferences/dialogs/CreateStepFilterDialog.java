...
package org.eclipse.dltk.mod.debug.ui.preferences.dialogs;
			...
			public void modifyText(ModifyEvent e) {
				...
				if (!filterValid)
					updateStatus(new StatusInfo(
							IStatus.ERROR,
							ScriptDebugPreferencesMessages.CreateStepFilterDialog_Invalid_Filter));
				else if (isDuplicateFilter(text.getText().trim())) {
					updateStatus(new StatusInfo(
							IStatus.WARNING,
							ScriptDebugPreferencesMessages.CreateStepFilterDialog_Duplicate_Filter));
					return;
				} else
					updateStatus(new StatusInfo());
				// EBAY MOD END
