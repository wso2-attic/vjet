...
/**
 * Rename type arguments describe the data that a rename type processor provides
 * to its rename type participants.
 * <p>
...
public class RenameTypeArguments extends RenameArguments {
	 ...
	 * @param updateSimilarDeclarations
	 *            <code>true</code> if similar declaration updating is
	 *            requested; <code>false</code> otherwise
	 * @param similarDeclarations
	 *            the similar declarations that will be updated or
	 *            <code>null</code> if similar declaration updating is not
	 *            requested
	 */
	public RenameTypeArguments(String newName, boolean updateReferences,
			boolean updateSimilarDeclarations,
			IModelElement[] similarDeclarations) {
	 ...
	 * 
	 * @return returns <code>true</code> if similar declaration updating is
	 *         requested; <code>false</code> otherwise
	 */
	 ...
	 * <code>null</code> if similar declaration updating is not requested.
	 * 
