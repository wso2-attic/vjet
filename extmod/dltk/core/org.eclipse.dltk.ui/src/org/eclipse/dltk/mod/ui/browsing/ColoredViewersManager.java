...
public class ColoredViewersManager implements IPropertyChangeListener {
	...
	private class ManagedViewer implements DisposeListener {
		...
		private final Style DECORATIONS_STYLE= new Style(DECORATIONS_COLOR_NAME); 
		...
		private ColoredString decorateColoredString(ColoredString string, String decorated, Style color) {
