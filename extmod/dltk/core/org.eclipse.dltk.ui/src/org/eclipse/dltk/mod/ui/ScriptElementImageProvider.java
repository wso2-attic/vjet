...
public class ScriptElementImageProvider {
	...
	private static final String LABELPROVIDERS_EXTENSION_POINT = "org.eclipse.dltk.mod.ui.scriptElementLabelProviders"; //$NON-NLS-1$
	...
	protected ILabelProvider getContributedLabelProvider(IModelElement element) {
		// private ILabelProvider getContributedLabelProvider(IModelElement
		// element) {
		// eBay mod end
