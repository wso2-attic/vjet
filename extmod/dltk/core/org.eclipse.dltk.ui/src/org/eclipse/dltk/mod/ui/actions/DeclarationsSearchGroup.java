...
public class DeclarationsSearchGroup extends ActionGroup {
	...
	public DeclarationsSearchGroup(IWorkbenchSite site, IDLTKLanguageToolkit tk) {
		...
		fFindDeclarationsAction
				.setActionDefinitionId(IScriptEditorActionDefinitionIds.SEARCH_DECLARATIONS_IN_WORKSPACE);
		...
		fFindDeclarationsInProjectAction
				.setActionDefinitionId(IScriptEditorActionDefinitionIds.SEARCH_DECLARATIONS_IN_PROJECTS);
		...
		fFindDeclarationsInHierarchyAction
				.setActionDefinitionId(IScriptEditorActionDefinitionIds.SEARCH_DECLARATIONS_IN_HIERARCHY);
		...
		fFindDeclarationsInWorkingSetAction
				.setActionDefinitionId(IScriptEditorActionDefinitionIds.SEARCH_DECLARATIONS_IN_WORKING_SET);
	...
	public DeclarationsSearchGroup(ScriptEditor editor, IDLTKLanguageToolkit tk) {
		...
		fFindDeclarationsAction
				.setActionDefinitionId(IScriptEditorActionDefinitionIds.SEARCH_DECLARATIONS_IN_WORKSPACE);
		fEditor.setAction(
				"SearchDeclarationsInWorkspace", fFindDeclarationsAction); //$NON-NLS-1$
		...
		fEditor
				.setAction(
						"SearchDeclarationsInProjects", fFindDeclarationsInProjectAction); //$NON-NLS-1$
		...
		fEditor
				.setAction(
						"SearchDeclarationsInHierarchy", fFindDeclarationsInHierarchyAction); //$NON-NLS-1$
		...
		fEditor
				.setAction(
						"SearchDeclarationsInWorkingSet", fFindDeclarationsInWorkingSetAction); //$NON-NLS-1$
	}
	...
	private void addWorkingSetAction(IWorkingSet[] workingSets,
		...
		if (fEditor != null)
			action = new WorkingSetFindAction(
					fEditor,
					new FindDeclarationsInWorkingSetAction(fEditor, workingSets) {
						protected IDLTKLanguageToolkit getLanguageToolkit() {
							return toolkit;
						}
			...
			action = new WorkingSetFindAction(fSite,
					new FindDeclarationsInWorkingSetAction(fSite, workingSets) {
						protected IDLTKLanguageToolkit getLanguageToolkit() {
							return toolkit;
						}
					}, SearchUtil.toString(workingSets));
	...
	public void fillContextMenu(IMenuManager manager) {
		IMenuManager javaSearchMM = new MenuManager(MENU_TEXT,
	...
	private void updateGlobalActionHandlers() {
		if (fActionBars != null) {
			fActionBars.setGlobalActionHandler(
					DLTKActionConstants.FIND_DECLARATIONS_IN_WORKSPACE,
					fFindDeclarationsAction);
			fActionBars.setGlobalActionHandler(
					DLTKActionConstants.FIND_DECLARATIONS_IN_PROJECT,
					fFindDeclarationsInProjectAction);
			fActionBars.setGlobalActionHandler(
					DLTKActionConstants.FIND_DECLARATIONS_IN_HIERARCHY,
					fFindDeclarationsInHierarchyAction);
			fActionBars.setGlobalActionHandler(
					DLTKActionConstants.FIND_DECLARATIONS_IN_WORKING_SET,
					fFindDeclarationsInWorkingSetAction);
		}
	}
