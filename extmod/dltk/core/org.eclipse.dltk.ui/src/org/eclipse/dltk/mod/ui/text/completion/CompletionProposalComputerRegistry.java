...
public final class CompletionProposalComputerRegistry {
	 ...
	 * {@link org.eclipse.dltk.mod.ui.text.IJavaPartitions} or
	 ...
	 * contract of {@link org.eclipse.dltk.mod.ui.text.java.IScriptCompletionProposalComputer}. When
        	...
        	protected Control createCustomArea(Composite parent) {
        		...
        		link.addSelectionListener(new SelectionAdapter() {
        			public void widgetSelected(SelectionEvent e) {
        				PreferencesUtil.createPreferenceDialogOn(getShell(), "org.eclipse.dltk.mod.ui.preferences.CodeAssistPreferenceAdvanced", null, null).open(); //$NON-NLS-1$
        			}
        		});
