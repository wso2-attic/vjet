...
public final class SearchMessages extends NLS {
	...
	private static final String BUNDLE_NAME = "org.eclipse.dltk.mod.internal.ui.search.SearchMessages";//$NON-NLS-1$
	...
	// eBay Mod. Start
	public static String SearchPage_CopyQualifiedNameAction_ActionName;
	// eBay Mod. End
	...
	public static String MatchFilter_PublicFilter_name;
	public static String MatchFilter_PublicFilter_actionLabel;
	public static String MatchFilter_PublicFilter_description;
