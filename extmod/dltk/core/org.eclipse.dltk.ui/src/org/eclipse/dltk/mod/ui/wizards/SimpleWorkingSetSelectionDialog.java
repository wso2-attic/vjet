 ...
 * EBAY MOD
 * Extract from
 * org.eclipse.jdt.internal.ui.workingsets.SimpleWorkingSetSelectionDialog(eclipse 3.3) for
...
public class SimpleWorkingSetSelectionDialog extends SelectionDialog {
	...
	protected void createButtonsForRightButtonBar(Composite bar) {
		...
		fSelectAll.setText(Messages.SimpleWorkingSetSelectionDialog_SelectAll_button); 
		...
		fDeselectAll.setText(Messages.SimpleWorkingSetSelectionDialog_DeselectAll_button); 
		...
		fNewWorkingSet.setText(Messages.SimpleWorkingSetSelectionDialog_New_button); 
...
//			return;
		...
		IWorkingSetNewWizard wizard= manager.createWorkingSetNewWizard(new String[] {JavaWorkingSetUpdater_ID});
