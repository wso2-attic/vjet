...
import org.eclipse.dltk.mod.compiler.util.Messages;
...
public class DefaultProblem extends CategorizedProblem {
	...
	public static final String MARKER_TYPE_PROBLEM = "org.eclipse.dltk.mod.core.problem"; //$NON-NLS-1$

	public static final String MARKER_TYPE_TASK = "org.eclipse.dltk.mod.core.task"; //$NON-NLS-1$
	...
	/**
	 * @see org.eclipse.dltk.mod.core.compiler.CategorizedProblem#getCategoryID()
	 */
	 ...
	 * 
	 * @see org.eclipse.dltk.mod.core.compiler.IProblem#getID()
	 * @return int
	 */
	public int getID() {
		return this.id;
	 ...
	 * 
	 * @see org.eclipse.dltk.mod.core.compiler.CategorizedProblem#getMarkerType()
	 */
	...
	public boolean isError() {
		// EBay modify for ingore case
		return this.severity != -1
				&& (this.severity & ProblemSeverities.Error) != 0;
	}
