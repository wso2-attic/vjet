...
public interface IScriptModelMarker {
	 ...
	 * <code>"org.eclipse.dltk.mod.core.problem"</code>). This can be used to
	 ...
	 * <code>"org.eclipse.dltk.mod.core.transient_problem"</code>). This can be
	 ...
	 * transient problems.
	 * 
	 * @see org.eclipse.dltk.mod.core.compiler.IProblem
	 * @see org.eclipse.dltk.mod.core.eval.ICodeSnippetRequestor#acceptProblem(org.eclipse.core.resources.IMarker,String,
	 *      int)
	 */
	 ...
	 * <code>"org.eclipse.dltk.mod.core.task"</code>). This can be used to
	 ...
	 * <code>"org.eclipse.dltk.mod.core.compiler.taskTag"</code>.
	 * 
	 * 
	 */
	 ...
	 * <code>"org.eclipse.dltk.mod.core.buildpath_problem"</code>). This can be
