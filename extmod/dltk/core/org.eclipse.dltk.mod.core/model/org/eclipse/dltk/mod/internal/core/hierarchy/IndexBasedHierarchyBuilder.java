...
import org.eclipse.dltk.mod.compiler.util.HashtableOfObject;
import org.eclipse.dltk.mod.compiler.util.HashtableOfObjectToInt;
...
import org.eclipse.dltk.mod.internal.core.IPathRequestor;
...
import org.eclipse.dltk.mod.internal.core.search.SubTypeSearchJob;
import org.eclipse.dltk.mod.internal.core.search.matching.SuperTypeReferencePattern;
...
public class IndexBasedHierarchyBuilder extends HierarchyBuilder {
	...
	private void buildForProject(ScriptProject project,
		...
		if (openablesLength > 0) {
			...
			org.eclipse.dltk.mod.core.ISourceModule[] unitsToLookInside = null;
			if (inProjectOfFocusType) {
				org.eclipse.dltk.mod.core.ISourceModule unitToLookInside = focusType
						.getSourceModule();
	...
	private void buildFromPotentialSubtypes(String[] allPotentialSubTypes,
		...
		if (workingCopies != null && (wcLength = workingCopies.length) > 0) {
			...
			for (int i = 0; i < wcLength; i++) {
				org.eclipse.dltk.mod.core.ISourceModule workingCopy = workingCopies[i];
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				try {
					...
					Openable handle;
					org.eclipse.dltk.mod.core.ISourceModule workingCopy = (org.eclipse.dltk.mod.core.ISourceModule) wcPaths
							.get(resourcePath);
					if (workingCopy != null) {
