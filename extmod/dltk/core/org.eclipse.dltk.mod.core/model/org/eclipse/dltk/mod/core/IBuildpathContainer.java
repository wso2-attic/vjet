 ...
 * for each referenced container (through the extension point "org.eclipse.dltk.mod.core.buildpathContainerInitializer").
 * <p>
 * @see IbuildpathEntry
	 *
 */
...
public interface IBuildpathContainer {
	 ...
	 * registered on the extension point "org.eclipse.dltk.mod.core.buildpathContainerInitializer", which can
