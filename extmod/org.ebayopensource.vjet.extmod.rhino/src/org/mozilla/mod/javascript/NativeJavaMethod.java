...
public class NativeJavaMethod extends BaseFunction
{
                       ...
                       Object[] args)
    {
        ...
        if (meth.vararg) {
            ...
            //EBAY MOD - handling cases where argTypes.length < args.length
            ...
            if (argTypes.length < args.length) {
            	Object[] newArgs = new Object[argTypes.length];
            	System.arraycopy(args, 0, newArgs, 0, argTypes.length);
            	args = newArgs;
            }
        }
        Object javaObject;
                            ...
                            MemberBox[] methodsOrCtors, Object[] args)
    {
        if (methodsOrCtors.length == 0) {
            ...
            if (member.vararg) {
            	...
            	//EBAY MOD - to simulate JavaScript to ignore extra args
                //if (alength != args.length) {
            	if (alength > args.length) {
                    return -1;
                }
