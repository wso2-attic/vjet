...
public interface Scriptable {
     ...
     * @see org.mozilla.mod.javascript.Scriptable#get(String, Scriptable)
     * @see org.mozilla.mod.javascript.ScriptableObject#getProperty(Scriptable, String)
     */
     ...
     * @see org.mozilla.mod.javascript.ScriptableObject#getProperty(Scriptable, int)
     */
     ...
     * @see org.mozilla.mod.javascript.Scriptable#get(int, Scriptable)
     * @see org.mozilla.mod.javascript.ScriptableObject#putProperty(Scriptable, int, Object)
     * @see org.mozilla.mod.javascript.Context#toObject(Object, Scriptable)
     */
     ...
     * @see org.mozilla.mod.javascript.Scriptable#get(String, Scriptable)
     * @see org.mozilla.mod.javascript.ScriptableObject#deleteProperty(Scriptable, String)
     */
     ...
     * @param index the numeric index for the property
     * @see org.mozilla.mod.javascript.Scriptable#get(int, Scriptable)
     * @see org.mozilla.mod.javascript.ScriptableObject#deleteProperty(Scriptable, int)
     */
