...
import org.eclipse.mod.wst.jsdt.internal.compiler.util.HashtableOfInt;
...
public static HashtableOfInt loadMessageTemplates(Locale loc) {
	...
	String bundleName = "org.eclipse.mod.wst.jsdt.internal.compiler.problem.messages"; //$NON-NLS-1$
	try {
