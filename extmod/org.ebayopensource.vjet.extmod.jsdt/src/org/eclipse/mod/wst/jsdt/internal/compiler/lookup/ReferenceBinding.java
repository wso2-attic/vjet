...
/**
 * @see org.eclipse.mod.wst.jsdt.internal.compiler.env.IDependent#getFileName()
 */
...
/**
 * @see org.eclipse.mod.wst.jsdt.internal.compiler.lookup.TypeBinding#isThrowable()
 */
 ...
 * @see org.eclipse.mod.wst.jsdt.internal.compiler.lookup.TypeBinding#isUncheckedException(boolean)
 */
public boolean isUncheckedException(boolean includeSupertype) {
	if (JavaScriptConstants.IS_ECMASCRIPT4)	// no checked exceptions for now
	{
	switch (this.id) {
			case TypeIds.T_JavaLangError :
			case TypeIds.T_JavaLangRuntimeException :
