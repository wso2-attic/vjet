...
import org.eclipse.mod.wst.jsdt.internal.compiler.parser.JavadocTagConstants;
...
public class Javadoc extends ASTNode implements IJsDoc {
	...
	public ASTNode getNodeStartingAt(int start) {
		...
		if (this.seeReferences != null) {
			...
			for (int i=0; i<length; i++) {
				org.eclipse.mod.wst.jsdt.internal.compiler.ast.Expression expression = this.seeReferences[i];
